  ...
  initialiseDevice (device) {
    ...
    try {
      ...
      if (device.httpInfo) {
        ...
        if (btClient && btFlag && accessory.context.isBluetooth) {
    ...
    try {
      if (accessory.btControl) {
        if (accessory.context.onlineBT) {
          ...
          throw new Error(this.lang.notConnected)
        }
      } else {
  ...
  updateAccessoryBTStatus (accessory, newStatus) {
    ...
    if (newStatus) {
      ...
      accessory
        ...
        .updateCharacteristic(this.cusChar.BluetoothConn, true)
    } else {
      if (accessory.context.onlineBT && accessory.context.enableLogging) {
      ...
      accessory
        .getService(this.api.hap.Service.Lightbulb)
        .updateCharacteristic(this.cusChar.BluetoothConn, false)
    }
