...
try {
  /*
    ...
    This if statement follows the logic of Noble upto the offending socket.bindRaw(device)
    Put this inside a try/catch now to check for error and disable ble control for rest of plugin
  */
