    ...
    return await this.queue.add(async () => {
      ...
      try {
        ...
        try {
          ...
          if (!this.consts.supportedCmds.aws.includes(params.cmd)) {
        ...
        // Bluetooth nor API support scenes yet so return now
        if (params.cmd === 'scene') {
          return
        }
        ...
        if (!this.consts.supportedCmds.ble.includes(params.cmd)) {
        ...
        */
        ...
        if (accessory.context.useAPIControl && this.consts.supportedCmds.api.includes(params.cmd)) {
