...
module.exports = {
  ...
  allowed: {
    ...
    leakDevices: ['label', 'deviceId', 'ignoreDevice', 'enableAWS', 'overrideLogging'],
  ...
  supportedCmds: {
    api: ['state', 'brightness', 'color', 'colorTem'],
    aws: ['state', 'brightness', 'color', 'scene'],
    ble: ['state', 'brightness', 'color', 'colorTem']
  }
}
