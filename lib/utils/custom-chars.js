  ...
  constructor (api) {
    ...
    this.uuids = {
      ...
      */
      ...
      effectKey: 'CC712AED-9A0E-4DAF-B50C-28B00B339076'
    }
    const self = this
    ...
    this.EffectKey = function () {
      self.hapChar.call(this, 'Effect Key', self.uuids.effectKey)
      this.setProps({
    ...
    inherits(this.EffectKey, this.hapChar)
    ...
    this.EffectKey.UUID = this.uuids.effectKey
  }
}
