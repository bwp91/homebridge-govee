  ...
  constructor (api) {
    ...
    this.uuids = {
      ...
      */
      ...
      effectCommand: '54830AAC-7143-412C-A29D-3D11BEC3B86D'
    }
    const self = this
    ...
    this.EffectCommand = function () {
      self.hapChar.call(this, 'Effect Command', self.uuids.effectCommand)
      this.setProps({
        format: self.hapChar.Formats.STRING,
        perms: [self.hapChar.Perms.READ, self.hapChar.Perms.WRITE]
      })
      this.value = this.getDefaultValue()
    }
    ...
    inherits(this.EffectCommand, this.hapChar)
    ...
    this.EffectCommand.UUID = this.uuids.effectCommand
  }
}
