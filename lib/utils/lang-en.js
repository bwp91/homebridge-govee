export default {
  ...
  apiPollingIncrease: 'Due to amount of API devices, increasing API polling to',
  apiPollingWhitelist: 'Not increasing API polling as API whitelist selected',
  availableAPI: (n) => `API client enabled and found ${n} devices`,
  availableAWS: (n) => `HTTP/AWS clients enabled and found ${n} device(s).`,
  availableBLE: 'BLE client enabled as packages successfully found',
  availableLAN: (n) => `LAN client enabled and initial scan found ${n} device(s)`,
  brand: 'Govee',
  ...
  btScanDisabled: 'BLE scanning for thermo-hygrometer sensors disabled as',
  btScanNoStart: 'Could not start BLE sync as',
  btScanNoStop: 'Could not stop BLE sync as',
  btScanUnknown: 'BLE reading received for unknown accessory',
  ...
  disableLAN: 'Disabling LAN client as',
  ...
  lanStartUpdate: 'starting update with params',
  lanUnkDevice: 'received update from unknown device',
  noAPIKey: 'API key not provided',
  noLANEnabled: ' the LAN client is not enabled',
