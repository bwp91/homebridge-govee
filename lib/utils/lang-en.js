...
module.exports = {
  ...
  couldSupport: 'exists but is not officially supported, please open a Github issue',
  ...
  devNotControl: 'device is reported offline, see http://bit.ly/hb-govee-errors for info',
  ...
  offline: 'has been reported offline, please check the wifi connection',
  online: 'has been reported online',
  receivingUpdate: 'received update',
  sendingAnyway: 'has been reported offline but force sending update as per config',
