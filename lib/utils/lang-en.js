export default {
  ...
  apiPollingIncrease: '[API] due to amount of devices, increasing polling to',
  availableAPI: (n) => `[API] client enabled and found ${n} devices`,
  availableAWS: '[AWS] client enabled',
  availableBLE: '[BLE] client enabled',
  availableHTTP: (n) => `[HTTP] client enabled and found ${n} device(s).`,
  availableLAN: (n) => `[LAN] client enabled and initial scan found ${n} device(s)`,
  brand: 'Govee',
  btNoPackage: 'required hardware/packages not available',
  btScanDisabled: '[BLE] sync for thermo-hygrometer sensors disabled as',
  btScanNoStart: '[BLE] could not start sync as',
  btScanNoStop: '[BLE] could not stop sync as',
  ...
  devNotRet: '[API] skipping sync as device status not retrievable',
  ...
  disableAPI: '[API] disabling client as',
  disableBT: '[BLE] disabling client as',
  disableHTTP: '[HTTP] disabling client as',
  disableLAN: '[LAN] disabling client as',
  ...
  logoutFail: '[HTTP] could not log out of Govee account as',
  ...
  sendingUpdateBLE: '[BLE] sending update',
  sendingUpdateLAN: '[LAN] starting update',
  ...
  syncFailAWS: '[AWS] sync failed as',
  syncFailHTTP: '[HTTP] sync failed as',
