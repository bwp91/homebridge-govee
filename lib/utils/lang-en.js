...
module.exports = {
  ...
  cmdNotBT: 'command not supported via bluetooth',
  ...
  devNotSupp: 'is not configured for bluetooth or not supported or by the plugin',
  ...
  disableAPI: 'Disabling API (cloud) client as',
  disableBT: 'Disabling BLE (bluetooth) client as',
  ...
  notBTSent: 'reverting to aws/cloud as',
