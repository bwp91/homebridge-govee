export default {
  ...
  availableAPI: 'API client enabled as Govee API key provided',
  availableAWS: 'HTTP/AWS clients enabled as Govee username and password provided',
  availableBLE: 'BLE client enabled as packages successfully found',
  availableLAN: 'LAN client enabled',
  brand: 'Govee',
