...
export default class {
              ...
              entries.forEach((subEntry) => {
                ...
                switch (k) {
                  ...
                  case 'videoModeTwo': {
                    ...
                    if (typeof v === 'object') {
                      // object - only allowed keys are 'sceneCode'
  ...
  receiveDeviceUpdate(accessory, params) {
    ...
    */
    ...
    } else if (params.cmd === 'colorwc' && colourParams.color) {
      if (hasProperty(colourParams.color, 'red')) {
        data.rgb = {
          r: colourParams.color.red,
          g: colourParams.color.green,
          b: colourParams.color.blue,
        };
      } else if (hasProperty(colourParams.color, 'r')) {
        data.rgb = {
