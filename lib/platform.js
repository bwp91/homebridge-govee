  ...
  initialiseDevice(device) {
    ...
    try {
      ...
      if (platformConsts.models.rgb.includes(device.model)) {
        ...
        devInstance = device.model === 'H7142'
          ? deviceTypes.deviceHumidifierH7142
          : deviceTypes.deviceHumidifier;
        ...
        devInstance = device.model === 'H7122'
          ? deviceTypes.devicePurifierH7122
          : deviceTypes.devicePurifier;
        accessory = devicesInHB.get(uuid) || this.addAccessory(device);
