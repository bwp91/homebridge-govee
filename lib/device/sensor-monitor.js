    ...
    (params.commands || []).forEach((command) => {
      ...
      switch (deviceFunction) {
        ...
        case 'aa0e':
          break;
        default: {
          const tempInCen = Math.round((hexToDecimal(`0x${deviceFunction}`) + this.accessory.context.offTemp) / 10) / 10;
          ...
          const humiDec = Math.round(`0x${humiHex}` / 100) + this.accessory.context.offHumi;
