    ...
    (params.commands || []).forEach((command) => {
      switch (command) {
        ...
        case 'qh8AAAAAAAAAAAAAAAAAAAAAALU=':
          ...
          break;
        case 'qgUDAZAEAAAAAAAAAAAAAAAAADk=': // 5
        case 'qgUDAZBoAAAAAAAAAAAAAAAAAFU=': // 6
        case 'qgUDAZEwAAAAAAAAAAAAAAAAAAw=': // 7
        case 'qgUDAZH4AAAAAAAAAAAAAAAAAMQ=': // 8
        case 'qgUDAZLAAAAAAAAAAAAAAAAAAP8=': // 9
        case 'qgUDAZOIAAAAAAAAAAAAAAAAALY=': // 10
        case 'qgUDAZPsAAAAAAAAAAAAAAAAANI=': // 11
        case 'qgUDAZS0AAAAAAAAAAAAAAAAAI0=': // 12
        case 'qgUDAZV8AAAAAAAAAAAAAAAAAEQ=': // 13
        case 'qgUDAZZEAAAAAAAAAAAAAAAAAH8=': // 14
        case 'qgUDAZcMAAAAAAAAAAAAAAAAADY=': // 15
        case 'qgUDAZdwAAAAAAAAAAAAAAAAAEo=': // 16
        case 'qgUDAZg4AAAAAAAAAAAAAAAAAA0=': // 17
        case 'qgUDAZkAAAAAAAAAAAAAAAAAADQ=': // 18
        case 'qgUDAZnIAAAAAAAAAAAAAAAAAPw=': // 19
        case 'qgUDAZqQAAAAAAAAAAAAAAAAAKc=': // 20
        case 'qgUDAZr0AAAAAAAAAAAAAAAAAMM=': // 21
        case 'qgUDAZu8AAAAAAAAAAAAAAAAAIo=': // 22
        case 'qgUDAZyEAAAAAAAAAAAAAAAAALU=': // 23
        case 'qgUDAZ1MAAAAAAAAAAAAAAAAAHw=': // 24
        case 'qgUDAZ4UAAAAAAAAAAAAAAAAACc=': // 25
        case 'qgUDAZ54AAAAAAAAAAAAAAAAAEs=': // 26
        case 'qgUDAZ9AAAAAAAAAAAAAAAAAAHI=': // 27
        case 'qgUDAaAIAAAAAAAAAAAAAAAAAAU=': // 28
        case 'qgUDAaDQAAAAAAAAAAAAAAAAAN0=': // 29
        case 'qgUDAaGYAAAAAAAAAAAAAAAAAJQ=': // 30
          return;
        default: {
