...
// TODO
// Changing to AUTO mode in the home app should send the code to change to AUTO mode in the govee app with the cache temp
// Changing to HEAT mode in the home app should send the code to change to the cache mode.
// Check that changing the fan speed in AUTO mode changes to HEAT mode in the home app and the correct mode in the govee app
// Check that changing the fan speed in OFF mode changes to HEAT mode in the home app and the correct mode in the govee app
// Check that changing the target temperature in HEAT mode changes to AUTO mode in the home app and the correct mode in the govee app
/*
  H7131 and H7132
  {
    "mode": {
