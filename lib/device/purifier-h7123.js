...
export default class {
  constructor(platform, accessory) {
    ...
    if (this.service.testCharacteristic(this.hapChar.PM2_5Density)) {
      this.service.removeCharacteristic(this.hapChar.PM2_5Density);
    }
    ...
    (params.commands || []).forEach((command) => {
      ...
      switch (deviceFunction) {
        ...
        case 'aa19': {
          ...
          let newQual = parseInt(getTwoItemPosition(hexParts, 5), 10);
          if (newQual === 4) {
            newQual = 5;
          }
