...
export default class {
  constructor(platform, accessory) {
    ...
    // H5106 does not have a battery
    if (this.accessory.context.gvModel === 'H5106') {
      // Remove the battery service if it exists
      if (this.accessory.getService(this.hapServ.BatteryService)) {
        this.accessory.removeService(this.accessory.getService(this.hapServ.BatteryService));
      }
    } else {
