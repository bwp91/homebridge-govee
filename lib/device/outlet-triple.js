  ...
  externalUpdate(params) {
    ...
    if ([48, 51].includes(params.stateDual)) {
      ...
      if (newState !== this.cacheState1) {
        ...
        this.accessory.log(`[${this.service1.displayName}] ${platformLang.curState} [${this.cacheState1}]`);
      }
      if (newState !== this.cacheState2) {
        ...
        // Log the change if appropriate
        this.accessory.log(`[${this.service2.displayName}] ${platformLang.curState} [${this.cacheState2}]`);
      }
    }
