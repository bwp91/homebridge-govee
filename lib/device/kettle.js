  ...
  constructor(platform, accessory) {
    ...
    if (this.service1) {
      this.service1.getCharacteristic(this.hapChar.On)
        .updateValue(false)
        .onSet(async (value) => this.internalStateUpdate(this.service1, value, '3301010200000000000000000000000000000039'));
    }
    ...
    if (this.service2) {
      this.service2.getCharacteristic(this.hapChar.On)
        .updateValue(false)
        .onSet(async (value) => this.internalStateUpdate(this.service2, value, '3301010300000000000000000000000000000038'));
    }
    ...
    if (this.service3) {
      this.service3.getCharacteristic(this.hapChar.On)
        .updateValue(false)
        .onSet(async (value) => this.internalStateUpdate(this.service3, value, '3301010400000000000000000000000000000037'));
    }
    ...
    if (this.service4) {
      this.service4.getCharacteristic(this.hapChar.On)
        .updateValue(false)
        .onSet(async (value) => this.internalStateUpdate(this.service4, value, '3301010500000000000000000000000000000036'));
    }
