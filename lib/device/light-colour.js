...
module.exports = class deviceLightColour {
  constructor (platform, accessory) {
    ...
    //   for(const [effectKey, effectEnabled] of Object.entries(this.lightEffects)) {
    //     if (!effectEnabled) {
    //       // TODO
    //     }
    //     let effectData = this.platform.scenes[effectKey]
    //     let effectDevice = {
    ...
    //     let effectAccessory = this.platform.addAccessory(effectDevice)
