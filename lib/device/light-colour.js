...
module.exports = class deviceLightColour {
  constructor (platform, accessory) {
    ...
    if (this.accessory.context.isBluetooth) {
      ...
      if (!this.service.testCharacteristic(this.cusChar.BluetoothConn)) {
        this.service.addCharacteristic(this.cusChar.BluetoothConn)
      }
      ...
      if (this.service.testCharacteristic(this.cusChar.BluetoothConn)) {
        this.service.removeCharacteristic(
          this.service.getCharacteristic(this.cusChar.BluetoothConn)
        )
      }
    }
