...
export default class {
  constructor(platform, accessory) {
    ...
    this.device = awsIot.device({
      keyPath: path.resolve(dirname, './cert/testiot.cert.pkey'),
      certPath: path.resolve(dirname, './cert/testiot.cert.pem'),
      caPath: path.resolve(dirname, './cert/AmazonRootCA1.pem'),
